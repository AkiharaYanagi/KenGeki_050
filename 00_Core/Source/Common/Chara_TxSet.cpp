...
namespace GAME
{
	...
	void Chara_TxSet::Load ()
	{
		...
		(*m_gridTxFullBody)[CH_CLR_1][CHARA_REINA] = TxUtl::MakeTx_FromArchive ( U"FullBody\\Stand_Reina.png" );
		(*m_gridTxFullBody)[CH_CLR_2][CHARA_REINA] = TxUtl::MakeTx_FromArchive ( U"FullBody\\Stand_Reina_2p.png" );
		(*m_gridTxFullBody)[CH_CLR_1][CHARA_EIYUU] = TxUtl::MakeTx_FromArchive ( U"dummy.png" );
		(*m_gridTxFullBody)[CH_CLR_2][CHARA_EIYUU] = TxUtl::MakeTx_FromArchive ( U"dummy.png" );
		...
		(*m_gridTxStand)[CH_CLR_1][CHARA_REINA] = TxUtl::MakeTx_FromArchive ( U"Stand\\rn1.png" );
		(*m_gridTxStand)[CH_CLR_2][CHARA_REINA] = TxUtl::MakeTx_FromArchive ( U"Stand\\rn2.png" );
		(*m_gridTxStand)[CH_CLR_1][CHARA_EIYUU] = TxUtl::MakeTx_FromArchive ( U"dummy.png" );
		(*m_gridTxStand)[CH_CLR_2][CHARA_EIYUU] = TxUtl::MakeTx_FromArchive ( U"dummy.png" );
		...
		(*m_aryTxName)[CHARA_REINA] = TxUtl::MakeTx_FromArchive			( U"CharaSele\\Name\\CharaSele_Name_REINA.png" );
		(*m_aryTxName)[CHARA_EIYUU] = TxUtl::MakeTx_FromArchive			( U"dummy.png" );
		...
		(*m_gridTxCutIn)[CH_CLR_1][CHARA_REINA] = TxUtl::MakeTx_FromArchive ( U"CutIn\\CutIn_Reina_1p.png" );
		(*m_gridTxCutIn)[CH_CLR_2][CHARA_REINA] = TxUtl::MakeTx_FromArchive ( U"CutIn\\CutIn_Reina_2p.png" );
		(*m_gridTxCutIn)[CH_CLR_1][CHARA_EIYUU] = TxUtl::MakeTx_FromArchive ( U"dummy.png" );
		(*m_gridTxCutIn)[CH_CLR_2][CHARA_EIYUU] = TxUtl::MakeTx_FromArchive ( U"dummy.png" );
